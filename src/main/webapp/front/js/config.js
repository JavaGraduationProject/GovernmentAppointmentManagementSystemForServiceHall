...
var indexNav = [
    ...
    {
        name: '政务信息',
        url: './pages/zhengwu/list.html'
    },

]

var adminurl =  "http://localhost:8080/banshidatingzhengwuyue/admin/dist/index.html#/login";
